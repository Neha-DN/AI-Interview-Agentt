    ...
    <div className="min-h-screen bg-background">
      {iv.sessionId && iv.candidate ? (
        <InterviewRoom
          ...
          domain={String(iv.candidate.domain || iv.candidate.field || "Engineering")}
          interviewType={iv.candidate.interviewType || "technical"}
          difficulty={iv.candidate.difficulty || "intermediate"}
          onSend={iv.send}
